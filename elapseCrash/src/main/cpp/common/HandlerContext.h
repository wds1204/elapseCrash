...
#define GET_THREAD_STACK_TRACES_METHOD_NAME              "getThreadStackTraces"
#define GET_THREAD_STACK_TRACES_METHOD_NAME_SIGNATURE    "(Ljava/lang/String;)Ljava/lang/String;"
